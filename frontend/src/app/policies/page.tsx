  ...
  return (
    <div className="space-y-6 pb-16">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-white flex items-center gap-2.5">
              ...
              <span className="text-xs px-2.5 py-0.5 rounded-full bg-blue-950 border border-blue-500/30 text-blue-300 font-semibold font-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl border border-slate-800 bg-[#0d1322] shadow-xl p-5 space-y-5">
          ...
          <form onSubmit={handleSavePolicy} className="space-y-4 text-xs">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-slate-950 border border-slate-800 rounded-md text-white font-mono focus:border-blue-500 focus:outline-none"
              />
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full flex items-center justify-center gap-2 py-2 rounded-md bg-blue-600 hover:bg-blue-500 text-white font-bold transition shadow-md shadow-blue-500/20 disabled:opacity-50 cursor-pointer"
            >
              {saving ? (
        ...
        <div className="rounded-xl border border-slate-800 bg-[#0d1322] shadow-xl p-5 space-y-5">
          <div className="flex items-center justify-between border-b border-slate-800/80 pb-3">
            ...
            <span className="text-[10px] px-2 py-0.5 rounded bg-purple-950 text-purple-300 border border-purple-500/30 font-semibold">
              Live Evaluation
            </span>
          </div>
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-slate-950 border border-slate-800 rounded-md text-white focus:border-blue-500 focus:outline-none"
                >
            ...
            <button
              ...
              disabled={simulating}
              className="w-full flex items-center justify-center gap-2 py-2 rounded-md bg-purple-600 hover:bg-purple-500 text-white font-bold transition shadow-md shadow-purple-500/20 disabled:opacity-50 cursor-pointer"
            >
              {simulating ? (
                <RefreshCw className="w-4 h-4 animate-spin" />
              ) : (
            ...
            {previewResult && (
              <div
                className={`p-4 rounded-lg border space-y-2 mt-4 ${
